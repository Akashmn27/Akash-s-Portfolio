...
private whatsappNumber = '+918870172456'; // Replace with your WhatsApp number
private message = 'Hello, I am interested in your Work!';
  ...
  sendWhatsAppMessage(): void {
    ...
    showInstagramMessage(): void {
      alert('Follow me on Instagram at: in_love_sniper');
    }
}
